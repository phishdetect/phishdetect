...
func checkSuspiciousHostname(link *Link, page *Page, requests []Request, brands *Brands) bool {
	lowSuspects := []string{
		"auth",
		"authorise",
		"authorize",
...
func checkSuspiciousTLD(link *Link, page *Page, requests []Request, brands *Brands) bool {
	suspects := []string{
		".bank",
		".biz",
		".cc",
...
func checkSuspiciousBridges(link *Link, page *Page, requests []Request, brands *Brands) bool {
...
func checkEncodedDomain(link *Link, page *Page, requests []Request, brands *Brands) bool {
...
func checkExcessivePunct(link *Link, page *Page, requests []Request, brands *Brands) bool {
...
func checkNoTLS(link *Link, page *Page, requests []Request, brands *Brands) bool {
...
func checkB64Parameters(link *Link, page *Page, requests []Request, brands *Brands) bool {
...
func checkGoogleSafeBrowsing(link *Link, page *Page, requests []Request, brands *Brands) bool {
	if SafeBrowsingKey == "" {
		return false
	}
